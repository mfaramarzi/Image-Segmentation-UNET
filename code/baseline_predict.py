...
if __name__ == '__main__':
    ...
    val_data = list(zip(sorted(glob('/home/masoud/masoud/medical_image_segmentation-master/input/test/images/*.jpg')),
                          sorted(glob('/home/masoud/masoud/medical_image_segmentation-master/input/test/2nd_manual/*.gif')),
                        sorted(glob('/home/masoud/masoud/medical_image_segmentation-master/input/test/mask/*.gif'))))
