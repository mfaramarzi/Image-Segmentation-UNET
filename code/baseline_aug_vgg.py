...
VGG_PATH = "/home/masoud/masoud/medical_image_segmentation-master/code/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5"
...
if __name__ == '__main__':
    ...
    train_data = list(zip(sorted(glob('/home/masoud/masoud/medical_image_segmentation-master/input/training/images/*.tif')),
                          sorted(glob('/home/masoud/masoud/medical_image_segmentation-master/input/training/1st_manual/*.gif'))))
    ...
    history = model.fit_generator(gen(train_data, au=True), epochs=100, verbose=0,
